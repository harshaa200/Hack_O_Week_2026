...
const ZC = ['rgb(200,200,200)', 'rgb(160,160,160)', 'rgb(120,120,120)', 'rgb(90,90,90)'];
...
function cHeat(d) {
    ...
    Plotly.newPlot('heatChart', [{
        ...
        colorscale: [[0, 'rgb(40,40,40)'], [0.5, 'rgb(150,150,150)'], [1, 'rgb(230,230,230)']],
...
function cTemp(data) {
    Plotly.newPlot('tempChart', [{
        ...
        type: 'scatter', mode: 'markers', marker: { size: 3, color: 'rgba(200,200,200,.35)' }
    }],
...
function cOcc(data) {
    Plotly.newPlot('occChart', [{
        ...
        type: 'scatter', mode: 'markers', marker: { size: 3, color: 'rgba(160,160,160,.35)' }
    }],
